...
module.exports = async (member) => {
  ...
  let welcomechannel = db.fetch(`welcomeChannel_${member.guild.id}`)
  ...
  .setDescription(stripIndents(`Welcome ${member}!
...
We are honoured to have you here!`))
  ...
  if(member.guild.id === '692650451979731024') member.roles.add('692650817743749191')
}